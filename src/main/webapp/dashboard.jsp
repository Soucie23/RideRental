		...
		<div class="big-wrapper light">
			...
			<section class="trip">
				<div class="section__container trip__container">
					...
					<p class="section__subtitle">Explore Freely, Rent a Bike or
						Scooter Today!</p>
					<div class="trip__grid">
						...
						<div class="trip__card">
							<img src="assets/tvs.jpg" alt="trip" />
							<div class="trip__details">
								<p>TVS NTORQ 125</p>
								<div class="rating">
									<i class="ri-star-fill"></i> 4.2
						...
						<div class="trip__card">
							<img src="assets/bmw.jpg" alt="trip" />
							<div class="trip__details">
								<p>BMW F 850 GS</p>
								<div class="rating">
